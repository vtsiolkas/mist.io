...
class LibvirtNodeDriver(NodeDriver):
    ...
    def __init__(self, uri):
        ...
        #examples: uri = 'qemu+tcp://192.168.132.1:5000/system'
        #or uri = 'qemu+ssh://user@remote/system
    ...
    def list_nodes(self, show_hypervisor=True):
        ...
        for domain in domains:
            try:
                #this only works if real name is given to a guest VM's name. 
        ...
        if show_hypervisor:
            ...
            try:
                public_ip = socket.gethostbyname(name)
            except:
                public_ip = ''
            extra = {}
